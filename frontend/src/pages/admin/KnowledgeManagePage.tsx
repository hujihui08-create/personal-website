                      ...
                      hover:text-[var(--color-primary)] hover:bg-[var(--color-bg-secondary)] transition-colors"
								...
								<div className="px-[var(--space-lg)] py-[var(--space-md)]">
									<div className="space-y-4">
										<div className="border-2 border-dashed border-[var(--color-border-medium)] rounded-[var(--radius-lg)] p-6 text-center hover:border-[var(--color-accent)] transition-colors">
											<input
												type="file"
												id="doc-file"
												className="hidden"
