	...
	return (
		<div className="min-h-screen bg-[var(--color-bg-tertiary)]">
			<main className="max-w-6xl mx-auto px-[var(--space-md)] py-[var(--space-2xl)]">
					...
					<div className="flex flex-wrap gap-2">
						{tabs.map((tab) => (
							<motion.button
								...
								whileTap={{ scale: 0.98 }}
								className={`inline-flex items-center px-4 py-2 text-sm font-medium rounded-[var(--radius-md)] transition-all duration-[var(--duration-base)] ease-standard
									${
										activeTab === tab.key
				...
				<motion.div
					layout
					className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[var(--space-lg)]"
				>
					{isLoading
				...
				{!isLoading && totalPages > 1 && (
					<motion.div
						...
						className="flex items-center justify-center gap-2 mt-[var(--space-xl)]"
					>
						<button
